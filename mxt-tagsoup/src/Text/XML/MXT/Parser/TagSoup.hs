...
{- |
   Module     : Text.XML.MXT.Parser.TagSoup
...
import           Text.XML.MXT.DOM.Interface        (NsEnv, QName, XmlTrees,
                                                    ...
                                                    xmlNamespace,
                                                    xmlnsNamespace)
import           Text.XML.MXT.DOM.XmlNode          (isElem, mkAttr', mkCmt',
                                                    mkElement, mkError',
                                                    mkText')
import           Text.XML.MXT.Parser.HtmlParsec    (closesHtmlTag,
                                                    isEmptyHtmlTag,
                                                    isInnerHtmlTagOf)

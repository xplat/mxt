...
{- |
   Module     : Text.XML.MXT.Arrow.ExpatInterface
...
import qualified Text.XML.MXT.Core                      as X
...
> ...
> import Text.MXT.XML.Core
> import Text.MXT.XML.Expat
> ...
>
...
-- | Turns off expat parsing. The build in MXT parsers will be used.

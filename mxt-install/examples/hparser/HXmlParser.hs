...
import Text.XML.MXT.Cache               -- import cache stuff
import Text.XML.MXT.TagSoup             -- import TagSoup parser
import Text.XML.MXT.Curl                -- import curl HTTP handler
import Text.XML.MXT.HTTP                -- import native HTTP handler
import Text.XML.MXT.Expat               -- import expat parser

...
import           Text.XML.MXT.Monad.Edit              (canonicalizeAllNodes,
                                                       canonicalizeForXPath,
                                                       rememberDTDAttrl,
                                                       removeDocWhiteSpace)
import           Text.XML.MXT.Monad.ParserInterface
import           Text.XML.MXT.Monad.ProcessDocument   (andValidateNamespaces,
                                                       getDocumentContents,
                                                       parseHtmlDocument,
                                                       parseXmlDocument, parseXmlDocumentWithExpat, propagateAndValidateNamespaces)
import           Text.XML.MXT.Monad.XmlState
import           Text.XML.MXT.Monad.XmlState.TypeDefs
...
a value of type 'Text.XML.MXT.XmlState.TypeDefs.SysConfig'

for all available options see module 'Text.XML.MXT.Monad.XmlState.SystemConfig'
...
- @withTagSoup@ :
  ...
  This is only available when package mxt-tagsoup is installed and
  the source contains an @import Text.XML.MXT.TagSoup@.
...
- @withCurl [\<curl-option\>...]@ :
  ...
  This is only available when package mxt-curl is installed and
  the source contains an @import Text.XML.MXT.Curl@.

- @withHTTP [\<http-option\>...]@ :
  Use the Haskell HTTP package for HTTP access.
  This is only available when package mxt-http is installed and
  the source contains an @import Text.XML.MXT.HTTP@.
...
This requires packages \"mxt-curl\" and \"mxt-tagsoup\" to be installed
...
for minimal complete examples see 'Text.XML.MXT.Monad.WriteDocument.writeDocument'

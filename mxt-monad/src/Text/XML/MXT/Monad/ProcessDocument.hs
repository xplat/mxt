...
import           Text.XML.MXT.Monad.ParserInterface           (parseHtmlDoc,
                                                               parseXmlDoc)

import           Text.XML.MXT.Monad.Edit                      (substAllXHTMLEntityRefs,
                                                               transfAllCharRef)

import           Text.XML.MXT.Monad.GeneralEntitySubstitution (processGeneralEntities)

import           Text.XML.MXT.Monad.DTDProcessing             (processDTD)

import           Text.XML.MXT.Monad.DocumentInput             (getXmlContents)

import           Text.XML.MXT.Monad.DTDValidation.Validation  (generalEntitiesDefined,
                                                               getDTDSubset,
                                                               transform,
                                                               validate)
import           Text.XML.MXT.Monad.Namespace                 (propagateNamespaces, validateNamespaces)
...
{- |
   ...
   For supported protocols see 'Text.XML.MXT.Monad.DocumentInput.getXmlContents'
-}

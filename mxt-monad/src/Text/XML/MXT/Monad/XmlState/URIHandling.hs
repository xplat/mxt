...
module Text.XML.MXT.Monad.XmlState.URIHandling
where
...
import           Network.URI                               (URI, escapeURIChar,
                                                            isUnescapedInURI,
                                                            nonStrictRelativeTo,
                                                            parseURIReference,
                                                            uriAuthority,
...
expandURI               :: MonadSeq m => (String, String) -> m String
expandURI
...
getSchemeFromURI        :: MonadSeq m => String -> m String
...
getRegNameFromURI       :: MonadSeq m => String -> m String
...
getPortFromURI          :: MonadSeq m => String -> m String
...
getUserInfoFromURI              :: MonadSeq m => String -> m String
...
getFragmentFromURI      :: MonadSeq m => String -> m String
getFragmentFromURI      = getPartFromURI uriFragment

-- | arrow for computing the path component of an URI, fails if input is not a legal URI

getPartFromURI          :: MonadSeq m => (URI -> String) -> String -> m String
getPartFromURI sel

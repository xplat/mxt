...
module Text.XML.MXT.Monad.XmlState.RunIOStateArrow
where
...
import           Text.XML.MXT.Monad.XmlState.ErrorHandling
import           Text.XML.MXT.Monad.XmlState.TraceHandling
...
-- usually @f@ will start with a constant arrow (ignoring the input), e.g. a 'Text.XML.MXT.Arrow.ReadDocument.readDocument' arrow.
--
-- for usage see examples with 'Text.XML.MXT.Arrow.WriteDocument.writeDocument'
--
...
dummyHTTPHandler        = ( issueFatal $
                            ...
                            , "please install package mxt-curl and use 'withCurl' config option"
                            , "or install package mxt-http and use 'withHTTP' config option"
                            ]
                          )
                          >=>
...
dummyTagSoupParser      =  issueFatal $
                           ...
                           , "please install package mxt-tagsoup"
...
dummyExpatParser        =  issueFatal $
                           ...
                           , "please install package mxt-expat"
...
dummyRelaxValidator     =  issueFatal $
                           ...
                           , "please install package mxt-relaxng"
...
dummyXmlSchemaValidator =  issueFatal $
                           ...
                           , "please install package mxt-xmlschema"
...
dummyCacheRead          = const $
                          ...
                          , "please install package mxt-cache and use 'withCache' config option"
                          ]

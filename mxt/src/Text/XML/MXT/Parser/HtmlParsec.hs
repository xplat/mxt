...
{- |
   ...
   errror handling and IO is done in 'Text.XML.MXT.Parser.HtmlParser'
   or other modules
...
import Text.XML.MXT.Parser.XmlTokenParser       ( allBut
                                                , amp
                                                , dq
                                                , eq
                                                , gt
...
import Text.XML.MXT.Parser.XmlParsec            ( misc
                                                , parseXmlText
                                                , xMLDecl'
                                                )
import Text.XML.MXT.Parser.XmlCharParser        ( xmlChar
                                                , SimpleXParser
                                                , withNormNewline
                                                )

...
{- |
   Module     : Text.XML.MXT.Parser.XmlDTDParser
...
import Text.XML.MXT.DOM.ShowXml
    ( xshow
    )
import Text.XML.MXT.DOM.XmlNode                        ( mkDTDElem'
                                                       , mkText'
                                                       , mkError'
                                                       , isText
                                                       , isDTD
...
import qualified Text.XML.MXT.Parser.XmlTokenParser    as XT

import           Text.XML.MXT.Parser.XmlCharParser     ( XParser
                                                       , XPState(..)
                                                       , withoutNormNewline
                                                       )

import qualified Text.XML.MXT.Parser.XmlCharParser     as XC
                                                       ( xmlSpaceChar )

import qualified Text.XML.MXT.Parser.XmlDTDTokenParser as XD
                                                       ( dtdToken )

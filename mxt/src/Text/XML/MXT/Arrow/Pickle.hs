...
module Text.XML.MXT.Arrow.Pickle
    ( xpickleDocument            -- from this module Text.XML.MXT.Arrow.Pickle
    , xunpickleDocument
    , xpickleWriteDTD
    , xpickleDTD
    , checkPickler
    ...
    , a_addDTD
      ...
      -- from Text.XML.MXT.Arrow.Pickle.Xml
    , pickleDoc
    , unpickleDoc
    , unpickleDoc'
    , showPickled
    ...
    , xpZero
      ...
      -- from Text.XML.MXT.Arrow.Pickle.Schema
    , Schema
    , Schemas
    , DataTypeDescr
    )
...
import           Text.XML.MXT.Arrow.Pickle.Xml
...
-- 'Text.XML.MXT.Arrow.writeDocument'. The option list is passed to 'Text.XML.MXT.Arrow.writeDocument'
--
...
--
-- The document is read with 'Text.XML.MXT.Arrow.readDocument'. Options are passed
-- to 'Text.XML.MXT.Arrow.readDocument'. The conversion from XmlTree is done with the
-- pickler.
--

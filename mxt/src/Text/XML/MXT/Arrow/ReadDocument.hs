...
import Text.XML.MXT.Arrow.Edit                  ( canonicalizeAllNodes
                                                , canonicalizeForXPath
                                                , canonicalizeContents
                                                , rememberDTDAttrl
                                                , removeDocWhiteSpace
                                                )
import qualified Text.XML.MXT.Arrow.ParserInterface as PI
import Text.XML.MXT.Arrow.ProcessDocument       ( getDocumentContents
                                                , parseXmlDocument
...
for all available options see module 'Text.XML.MXT.Arrow.XmlState.SystemConfig'
...
for minimal complete examples see 'Text.XML.MXT.Arrow.WriteDocument.writeDocument'

...
import Text.XML.MXT.Arrow.XmlState.RunIOStateArrow
                                                ( initialSysState
                                                )
import Text.XML.MXT.Arrow.Edit                  ( haskellRepOfXmlDoc
                                                , indentDoc
                                                , addDefaultDTDecl
...
import Text.XML.MXT.Arrow.DocumentOutput        ( putXmlDocument
                                                , encodeDocument
                                                , encodeDocument'
                                                )
...
this filter can be configured by an option list like 'Text.XML.MXT.Arrow.ReadDocument.readDocument'

usage: @ writeDocument optionList destination @

if @ destination @ is the empty string or \"-\", stdout is used as output device

for available options see 'Text.XML.MXT.Arrow.XmlState.SystemConfig'
...
-- The default may be overwritten with the 'Text.XML.MXT.Arrow.XmlState.SystemConfig.withOutputEncoding' option.

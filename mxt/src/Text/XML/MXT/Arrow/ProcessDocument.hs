...
import           Text.XML.MXT.Arrow.ParserInterface           (parseHtmlDoc,
                                                               parseXmlDoc)

import           Text.XML.MXT.Arrow.Edit                      (substAllXHTMLEntityRefs,
                                                               transfAllCharRef)

import           Text.XML.MXT.Arrow.GeneralEntitySubstitution (processGeneralEntities)

import           Text.XML.MXT.Arrow.DTDProcessing             (processDTD)

import           Text.XML.MXT.Arrow.DocumentInput             (getXmlContents)

import           Text.XML.MXT.Arrow.Namespace                 (propagateNamespaces, validateNamespaces)
import           Text.XML.MXT.DTDValidation.Validation        (generalEntitiesDefined,
                                                               getDTDSubset,
                                                               transform,
                                                               validate)
...
{- |
   ...
   For supported protocols see 'Text.XML.MXT.Arrow.DocumentInput.getXmlContents'
-}

...
{- |
   Module     : Text.XML.MXT.DOM.QualifiedName
...
import           Text.XML.MXT.DOM.XmlKeywords      (a_xml, a_xmlns,
                                                    xmlNamespace,
                                                    xmlnsNamespace)
...
-- When dealing with namespaces, the document tree must be processed by 'Text.XML.MXT.Arrow.Namespace.propagateNamespaces'

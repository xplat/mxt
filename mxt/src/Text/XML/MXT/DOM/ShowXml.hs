...
{- |
   Module     : Text.XML.MXT.DOM.ShowXml
...
import           Text.XML.MXT.DOM.XmlNode     (getDTDAttrl, mkDTDElem)
...
--
-- see also : 'xmlTreesToText' for filter version, 'Text.XML.MXT.Parser.XmlParsec.xread' for the inverse operation

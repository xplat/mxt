...
import qualified Text.XML.MXT.Arrow.ParserInterface      as V
import qualified Text.XML.MXT.Validator.ValidationFilter as F
...
-- test1 = main1 "/home/uwe/haskell/mxt/curr/examples/w3ctest/xml-test-suite/xmlconf/xmlconf.xml"

{- |
   The examples from the MXT tutorial at haskell.org "http://www.haskell.org/haskellwiki/MXT"
-}

module Main
where

import Text.XML.MXT.Core		-- basic MXT stuff
import Text.XML.MXT.XPath               -- additional XPath functions
import Text.XML.MXT.Curl                -- Curl HTTP handler

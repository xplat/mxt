...
The class {\tt XmlNode} in the module {\tt Text.XML.MXT.Arrow.XmlNode} defines all the functions for processing {\tt XNode} and {\tt NTree}. Since it is a type class, it only contains some default implementations but the real functionality is defined in the instances {\tt XNode} and {\tt NTree} of this class.\\
...
\begin{figure}[H]
        ...
        \label{mxt_structure}
        \includegraphics[width=\textwidth]{images/mxt-structure.eps}
\end{figure}

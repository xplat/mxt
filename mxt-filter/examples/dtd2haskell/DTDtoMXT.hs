...
-- Author : Uwe Schmidt
--
-- Version : $Id: DTDtoMXT.hs,v 1.2 2005/04/14 12:52:51 hxml Exp $
--
...
import Text.XML.MXT.Parser              -- import all stuff for parsing, validating, and transforming XML
    ...
    genHaskell dt
        = cat
          [ code [ sepl
                 ...
                 , "where"
                 , ""
                 , "import Text.XML.MXT.DOM.XmlTree (XmlFilter)"
                 , "import qualified Text.XML.MXT.DOM.XmlTree as X hiding (XmlFilter)"
                 ]

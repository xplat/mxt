...
import Text.XML.MXT.DOM.XmlTreeTypes
import Text.XML.MXT.DOM.XmlTreeFunctions
import Text.XML.MXT.DOM.XmlKeywords
import Text.XML.MXT.DOM.Unicode ( isXmlSpaceChar        )
import Text.XML.MXT.DOM.Util    ( decimalStringToInt    )

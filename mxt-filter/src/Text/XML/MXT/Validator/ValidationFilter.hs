...
import qualified Text.XML.MXT.Validator.DTDValidation as DTDValidation
import qualified Text.XML.MXT.Validator.DocValidation as DocValidation
import qualified Text.XML.MXT.Validator.IdValidation as IdValidation
import qualified Text.XML.MXT.Validator.DocTransformation as DocTransformation

...
{- |
   ...
   real work is done in 'Text.XML.MXT.Parser.HtmlParsec'
...
module Text.XML.MXT.Parser.HtmlParser
    ...
    , runHtmlParser
    , substHtmlEntities
    , module Text.XML.MXT.Parser.HtmlParsec
    )
...
import Text.XML.MXT.Parser.HtmlParsec
...
import Text.XML.MXT.Parser.XhtmlEntities
    ( xhtmlEntities
    )
...
--
-- The input tree must be a root tree like in ' Text.XML.MXT.Parser.MainFunctions.getXmlDoc'. The content is read with 'Text.XML.MXT.Parser.XmlInput.getXmlContents',
...
--
-- see also : 'Text.XML.MXT.Parser.DTDProcessing.getWellformedDoc'

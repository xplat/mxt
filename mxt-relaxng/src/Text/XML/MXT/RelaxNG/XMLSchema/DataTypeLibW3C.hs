...
{- |
   Module     : Text.XML.MXT.XMLSchema.DataTypeLibW3C
...
module Text.XML.MXT.RelaxNG.XMLSchema.DataTypeLibW3C
...
import           Text.XML.MXT.DOM.QualifiedName             (isNCName, isWellformedQualifiedName)

...
relaxSchemaFile = "Text/XML/MXT/RelaxNG/SpecificationSchema.rng"


relaxSchemaGrammarFile :: String
relaxSchemaGrammarFile = "Text/XML/MXT/RelaxNG/SpecificationSchemaGrammar.rng"
...
-- (see also: 'Text.XML.MXT.RelaxNG.Simplification.simplificationStep1')
--
...
-- (see also: 'simplificationStep1' in "Text.XML.MXT.RelaxNG.Simplification")

contextBaseAttr :: String
contextBaseAttr = "RelaxContextBaseURI"


-- see simplificationStep5 in Text.XML.MXT.RelaxNG.Simplification

...
{- |
   Module     : Text.XML.MXT.RelaxNG.Simplification
...
import Text.XML.MXT.Arrow.Edit                  ( removeWhiteSpace
                                                )
import Text.XML.MXT.Arrow.Namespace             ( processWithNsEnv
                                                )
import Text.XML.MXT.Arrow.XmlState
import Text.XML.MXT.Arrow.XmlState.TypeDefs

import Text.XML.MXT.RelaxNG.DataTypes
import Text.XML.MXT.RelaxNG.BasicArrows
import Text.XML.MXT.RelaxNG.CreatePattern
import Text.XML.MXT.RelaxNG.DataTypeLibraries
import Text.XML.MXT.RelaxNG.Utils
import Text.XML.MXT.RelaxNG.Validation
import Text.XML.MXT.RelaxNG.Schema        as S
import Text.XML.MXT.RelaxNG.SchemaGrammar as SG

{- |
   Module     : Text.XML.MXT.XMLSchema.W3CDataTypeCheckUtils
   ...
   Contains helper functions and datatypes to check basic W3C datatypes and params.
-}
...
import Text.XML.MXT.Parser.XmlCharParser  ( SimpleXParser
                                          , withNormNewline
                                          )
import Text.XML.MXT.Parser.XmlTokenParser ( skipS0
                                          , nmtoken
                                          , name
                                          )

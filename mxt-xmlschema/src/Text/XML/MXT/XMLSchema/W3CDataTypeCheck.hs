{- |
   Module     : Text.XML.MXT.XMLSchema.W3CDataTypeCheck
...
module Text.XML.MXT.XMLSchema.W3CDataTypeCheck
  ( module Text.XML.MXT.XMLSchema.DataTypeLibW3CNames
  , ParamList
  , datatypeAllowsW3C
  )
where

import Text.XML.MXT.XMLSchema.W3CDataTypeCheckUtils
import Text.XML.MXT.XMLSchema.DataTypeLibW3CNames
...
import Text.XML.MXT.DOM.QualifiedName ( isWellformedQualifiedName
                                      , isNCName
                                      )
import Text.XML.MXT.DOM.Util          ( normalizeWhitespace
                                      , normalizeBlanks
                                      , escapeURI
                                      )

...
{- |
   Module     : Text.XML.MXT.XMLSchema.ValidationTypes
...
import           Text.XML.MXT.Core            (QName, XmlTree, c_err, c_warn)
import           Text.XML.MXT.DOM.ShowXml     (xshow)

-- import Text.XML.MXT.Arrow.XmlRegex ( XmlRegex )
...
-- | A substitute for XmlRegex from mxt Arrow.XmlRegex

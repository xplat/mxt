...
{- |
   ...
   HXmlParser - with XML schema validation
...
import Text.XML.MXT.Curl		-- import HTTP access
import Text.XML.MXT.XMLSchema           -- import XML schema validation
...
usage errl
    ...
    header = "HXmlParser - Validating XML Parser of the Haskell XML Toolbox with Arrow Interface\n" ++
             "XML well-formed checker, DTD validator, XML schema validator, HTML parser.\n\n" ++
